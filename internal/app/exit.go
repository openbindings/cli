...
// okText creates a success ExitResult (code 0) with the given message to stdout.
func okText(message string) error {
	return ExitResult{Code: 0, Message: message, ToStderr: false}
}
